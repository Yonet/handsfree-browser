...
const ASSET_PATH = {};
ASSET_PATH[DEVICE.HEADSET] = '/assets/3d/headset.obj';
ASSET_PATH[DEVICE.CONTROLLER] = '/assets/3d/oculus-go-controller.glb';
...
ConfigurationManager.createFromJsonFile('assets/js/devices.json').then(manager => {
